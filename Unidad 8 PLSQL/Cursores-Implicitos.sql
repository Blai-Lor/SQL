...
/*  
1. Utilitza un cursor implícit FOR per passar per tots els empleats
...
BEGIN
    FOR emp IN(SELECT * FROM EMPLOYEES WHERE JOB_TITLE='Programmer') LOOP 
    DBMS_OUTPUT.PUT_LINE(emp.first_name || ' ' || emp.last_name);
    CASE WHEN EXTRACT(MONTH FROM emp.nice_date) IN (1,2,3) 
    THEN DBMS_OUTPUT_LINE('1rT');
    END CASE;
END LOOP;
END;