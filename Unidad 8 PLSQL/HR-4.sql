...
DECLARE
    ...
    FUNCTION GET_EMPLOYEE_ID(p_NAME VARCHAR2) RETURN NUMBER
    IS v_ID_EMP NUMBER; 
    BEGIN
        SELECT ID INTO v_ID_EMP FROM EMPLOYEE
        WHERE FIRST_NAME || LAST_NAME LIKE '%' || p_SEARCH || '%'
    ...
    END;
BEGIN
    DBMS_OUTPUT.PVT_LINE('ID:' || GET_EMPLOYEE_ID ('NAJOX'));
EXCEPTION
