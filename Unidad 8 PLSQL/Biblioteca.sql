...
DECLARE
    vClientDni VARCHAR2(9) := '00000000A';
    vLlibreId NUMBER := 1;
    vExemplars NUMBER;
BEGIN
    SELECT exemplars 
    ...
    FOR i IN 1..vExemplars LOOP
        UPDATE LLIBRE 
        SET exemplars = exemplars - 1 
        WHERE id = vLlibreId;

        INSERT INTO VENDA (DATA_VENDA, DNI_CLIENT, ID_LLIBRE, PREU) 
        VALUES (SYSTIMESTAMP, vClientDni, vLlibreId, 10);
    END LOOP;
END;