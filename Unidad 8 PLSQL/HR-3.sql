...
-- Enunciado
-- 1. Declara una funció que retorni el job_title d’un empleat (EMPLOYEES), donat el seu FIRST_NAME i LAST_NAME.
-- 2. Declara un procediment que “retorni” el correu electronic i el telèfon d’un empleat, donat el seu FIRST_NAME i LAST_NAME. 
-- Utilitza paràmetres OUT.
-- 3. Utilitza els dos subprogrames anteriors a un bloc anònim per obtenir el job_title, el correu i el telèfon de l’empleat “Blake Cooper”.

DECLARE
        FUNCTION GET_JOB_TITLE (P_FIRST_NAME VARCAHR2, P_LAST_NAME VARCHAR2)
...
BEGIN
    DBMS_OUTPUT:PULLINE(GET_TITLE('Blake','Cooper'));
END;
...
DECLARE 
    vEmail VARCHAR2(50);
    vTelefon VARCHAR2(50);
BEGIN
    GET_EMAIL_TELEFON ('Blake', 'Cooper', vEmail, vTelefon);
    DBMS_OUTPUT.PUT_LINE('Email: ' || vEmail);



/*
DECLARE
    -- 1. Funció per obtenir el job_title
    ...
    -- 2. Procediment per obtenir email i telèfon
    ...
    -- Variables per al bloc anònim
    v_job_title employees.job_title%TYPE;
    v_email     employees.email%TYPE;
    v_phone     employees.phone%TYPE;

BEGIN
    -- 3. Crida als subprogrames
    v_job_title := get_job_title('Blake', 'Cooper');
