...
CREATE OR REPLACE PACKAGE ORDERS_MGMT AS 
    TYPE T_products_emp IS TABLE OF PRODUCTS%ROWTYPE;

    FUNCTION get_status(p_order_id NUMBER) RETURN ORDERS.STATUS%TYPE;

    FUNCTION get_products_by_oreder(p_order_id NUMBER) RETURN T_col_prod;
END ORDERS_MGMT;