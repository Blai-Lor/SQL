...
val country_name countries.country_name%TYPE;
val region_id countries.region_id%TYPE;

DECLARE 
    vCountryName COUNTRIES.COUNTRY_NAME%TYPE;
    vPaisID varchar(2) := 'sp';
    vRegionID NUMBER;

BEGIN
    vPaisID := 'Spain';
    SELECT region_id INTO vRegionID FROM regions WHERRE regions_region_name='Europe';
    INSSERT INTO Countries VALUES 
END;